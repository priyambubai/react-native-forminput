...
export const getThemedColor = (theme: string, element: string) => {
    ...
    switch (element) {
        ...
        case 'inputContainerStyle':
            return { backgroundColor: theme === 'dark' ? colors.semiTransparentWhite : colors.transparentGrey };
        case 'labelTextStyle':
        ...
        case 'todayTextStyle':
            return { color: theme === 'dark' ? colors.lightGrey : colors.grey };
        case 'weekDaysContainerStyle':
            return { backgroundColor: theme === 'dark' ? colors.transparentWhite : colors.transparentBlack };
        case 'yearMonthContainerStyle':
            return { backgroundColor: theme === 'dark' ? colors.slightlyDarkGrey : colors.white };
        ...
        case 'yearMonthTimeSelectorTextStyle':
            return { color: theme === 'dark' ? colors.lightGrey : colors.slightlyDarkGrey };
        case 'datePickerOutsideDayTextStyle':
            return { color: theme === 'dark' ? colors.grey : colors.lightGrey };
        case 'timeTextStyle':
            return { color: theme === 'dark' ? colors.lightGrey : colors.grey };
    }
};
